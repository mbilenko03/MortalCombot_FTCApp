...
public class PBAutonomousBlueOp extends OpMode {
    ...
    public void init() {
        ...
        masterTask = new PBAutonomousMasterTask(pushbot, "Master Task", telemetry, PBAutonomousMasterTask.DriveMode.blue);
    }
